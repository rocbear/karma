...
var KarmaDsl = function(config) {
  ...
  var getterFor = function(object, prop) {
	  return Object.getOwnPropertyDescriptor(global, prop) && Object.getOwnPropertyDescriptor(global, prop).get;
  };
  
  ['JASMINE', 'MOCHA', 'QUNIT'].forEach(function(framework) {
    [framework, framework + '_ADAPTER'].forEach(function(name) {
      if (!getterFor(global, name))
	  {
